...
class YearFilter extends React.Component {
  render() {
    const chosenYear = this.props.chosenYear;
    const filterClass = chosenYear === this.props.year ?
    'bttnFilter chosenFilter' :
    'bttnFilter';
...
class MonthFilter extends React.Component {
  render() {
    const chosenMonth = this.props.chosenMonth;
    const filterClass = chosenMonth === this.props.month ?
    'bttnFilter chosenFilter' :
    'bttnFilter';
    return (
      <div className={filterClass}>
...
class Calendar extends React.Component {
  ...
  render() {
    ...
    this.props.products.forEach((product) => {
      if ((product.year !== lastYear)&&((product.year === this.state.chosenYear)||(this.state.chosenYear === null))) {
        rows.push(
          <ProductYear
      ...
      if (((product.month !== lastMonth)||(product.day !== lastDay))&&((product.month !== null)||(product.day !== null))&&((product.year === this.state.chosenYear)||(this.state.chosenYear === null))&&((product.month === this.state.chosenMonth)||(this.state.chosenMonth === ''))) {
        rows.push(
          <ProductMonthDay
            products={this.props.products}
            year={product.year}
      ...
      }else if (((product.month !== lastMonth)||(product.day !== lastDay))&&(product.day !== null)&&((product.year === this.state.chosenYear)||(this.state.chosenYear === null))&&((product.month === this.state.chosenMonth)||(this.state.chosenMonth === ''))) {
        rows.push(
          <ProductMonthDay
            products={this.props.products}
            year={product.year}
